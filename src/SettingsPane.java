...
public class SettingsPane extends GraphicsPane {
	...
	public SettingsPane(MainApplication app) {
		...
		diffButton = new GButton(diffList[Math.abs(difficultyChoice % 3)], BOX_X, DIFF_Y, BOX_WIDTH, BOX_HEIGHT,
				Color.GREEN);
	...
	public void mousePressed(MouseEvent e) {
		...
		if (obj == play) {
			...
			case 0:
				program.setSongChoice("hotelCali");
				break;
			case 1:
				program.setSongChoice("ToHellAndBack");
				break;
			case 2:
				program.setSongChoice("VTKTRS");
				break;
			}
		...
		case 0:
			diffButton.setFillColor(Color.GREEN);
			break;
		case 1:
			diffButton.setFillColor(Color.YELLOW);
			break;
		case 2:
			diffButton.setFillColor(Color.RED);
			break;
		}
