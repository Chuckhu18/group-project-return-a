...
public class MainMenuPane extends GraphicsPane {
	...
	public MainMenuPane(MainApplication app) { // always call this app
		...
		howTo = new GImage("howTobutton.png", mainMenu.getX() + 50, 300); // instantiating, an object is an instance of
																			// a class
		...
		toSettings.setLocation(howTo.getX() + howTo.getWidth() + toSettings.getWidth(),
				howTo.getY() + howTo.getHeight() / 2 - toSettings.getHeight() / 2);
		...
		howToBack.setLocation(howtoPlay.getX() + howToBack.getWidth() / 2,
				howtoPlay.getY() + howtoPlay.getHeight() + howToBack.getHeight() * 2);
